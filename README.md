...
This block has as allowed block the `add-to-list-btn` one.
...
Also, you can configure the block [add-to-list-btn](https://github.com/vtex-apps/wishlist) defined on product-summary.
